...
Verify.verifyContains(primaryArtifactFile, "misc/lorem-ipsum.txt")
Verify.verifyNotContain(primaryArtifactFile, "Log4j-config.xsd")
Verify.verifyNotContain(primaryArtifactFile, "Log4j-events.xsd")
