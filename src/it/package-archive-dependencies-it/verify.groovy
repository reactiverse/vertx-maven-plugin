...
Verify.verifyNotContain(primaryArtifactFile, "org/apache/commons/lang3/AnnotationUtils.class")
Verify.verifyContains(primaryArtifactFile, "Log4j-config.xsd")
Verify.verifyContains(primaryArtifactFile, "Log4j-events.xsd")
Verify.verifyNotContain(primaryArtifactFile, "Log4j-config.dtd")
